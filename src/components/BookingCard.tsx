...
interface BookingCardProps {
  ...
  /** "Prašoma 125 €", "Siūloma 100 €", "Sutarta 115 €": already worded by the page. */
  priceLine?: string | null;
  /**
   * Whether this viewer may accept what is on the table (see canAccept in lib/pricing). Defaults
   * to the sitter view, which is what accepting meant before offers existed.
   */
  canAccept?: boolean;
  /** The accept button's label, naming the amount. */
  acceptLabel?: string;
  /** Shown on a pending card when the other side has to answer. */
