...
import SitterCover from "@/components/SitterCover";
...
export default function SitterProfilePage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-10 sm:py-14">
      ...
      <SitterCover sitter={sitter} />
      {/* Pulled up over the cover so the header and price cards float on the photo as
          glass; they slide in without fading, because a parent animating opacity switches
          backdrop-filter off until the fade ends. Same layout as the public profile. */}
      <div className="relative -mt-16 sm:-mt-20 px-3 sm:px-5 grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            {activeServices.length === 0 ? (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                {activeServices.map(({ key, label }) => (
                  <div key={key} className="flex items-center justify-between p-3.5 bg-white/60 rounded-xl border border-black/5">
